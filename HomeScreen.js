import { StyleSheet, Text, View,SafeAreaView, Alert,Pressable,Image,TextInput,
...
const HomeScreen = () => {
  ...
  return (
        ...
        >
          ...
          <Pressable onPress={() => navigation.navigate("Profile")} style={{ marginLeft: "auto", marginRight: 7 }}>
            <Image
              ...
              source={{
            uri:"https://yt3.ggpht.com/uPqIYJNYAQ9BnhKqVDypXRK1vBxqXWVC9auYTk_Zz3VYneduPhnNBHn4Rjh_hKVAQyhXP3sV=s88-c-k-c0x00ffffff-no-rj"
         }}
         ></Image> 
    </Pressable>
    ...
    {total === 0 ? (
          ...
          >
            <View>
              <Text style={{fontSize:17,fontWeight:"600",color:"white"}}>{cart.length} items | Rupees  {total}</Text>
